...
export default function Impact() {
  const stories = [
    {
      name: "Sunita",
      prog: "Aarambh",
      text: "From village playgrounds to the national camp — Sunita’s big leap.",
    ...
    },
    {
      ...
      prog: "Lakshya",
      text: "Training at the High Performance Centre, Bhubaneswar for swimming excellence.",
  ...
  return (
    <>
      {/* ================= SEO ================= */}
      <SEO
        title="Impact | Future Star Sports Academy"
        description="Discover the impact of Future Star Sports Academy through athlete journeys, grassroots programs, and measurable social outcomes across communities."
        canonical="https://futurestarsportsacademy.org/impact"
      ...
      <div className="w-full bg-orange-50 text-[#0b3b67]">
        ...
        <section className="relative w-full h-[60vh] flex items-center justify-center text-center">
          <img
            ...
            alt="Future Star Sports Academy impact across communities"
            loading="eager"
            fetchpriority="high"
          />
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              {
                title: "Performance",
                desc: "Providing elite training and mentorship through Lakshya programs.",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <img
              ...
              alt="Sandhyarani Tudu national rugby camp athlete"
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold">
                Sandhyarani’s Journey — National Rugby Camp Athlete
              </h2>
              <p className="mt-4 text-gray-700 leading-relaxed">
                Sandhyarani Tudu joined FSSA’s Lakshya program at 15. With coaching,
                academic support, and mentorship, she earned a place in the India
                National Rugby Camp.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            {stories.map((story, index) => (
              ...
              >
                <img
                  src={story.img}
                  alt={`${story.name} athlete journey`}
